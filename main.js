...
//remote:
app.use(express.static(path.join(__dirname, '../assignment3-3-207698911_325516052_assignment2/dist')));

app.get("/",function(req,res)
{ 
  //remote: 
  res.sendFile(path.join(__dirname, '../assignment3-3-207698911_325516052_assignment2/dist/index.html'));
  //local:
